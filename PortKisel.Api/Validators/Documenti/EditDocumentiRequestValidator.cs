...
{
    public class EditDocumentiRequestValidator : AbstractValidator<EditDocumentiRequest>
    {
        public EditDocumentiRequestValidator(ICargoReadRepository cargoReadRepository,
            IVesselReadRepository vesselReadRepository,
            IStaffReadRepository staffReadRepository)
        {
            RuleFor(documenti => documenti.Id)
                .NotNull()
                .NotEmpty()
